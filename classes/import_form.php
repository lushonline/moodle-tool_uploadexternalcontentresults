...
class tool_uploadexternalcontentresults_import_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform = $this->_form;
        $element = $mform->createElement('filepicker', 'importfile', get_string('importfile', 'tool_uploadexternalcontentresults'));
        ...
        $this->add_action_buttons(false, get_string('import', 'tool_uploadexternalcontentresults'));
    }
