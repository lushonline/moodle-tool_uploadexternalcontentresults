...
class import_confirm_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'columnsheader', get_string('columnsheader', 'tool_uploadexternalcontentresults'));
        ...
        $this->add_action_buttons(true, get_string('confirm', 'tool_uploadexternalcontentresults'));
    }
}
