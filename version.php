...
$plugin->version   = 2020080100; // The current plugin version (Date: YYYYMMDDXX).
$plugin->requires  = 2016120500; // Requires this Moodle version v3.2 see https://docs.moodle.org/dev/Releases.
